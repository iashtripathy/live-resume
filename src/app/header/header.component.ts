  ...
  async share() {
    try{
      await this.ngNavigatorShareService.share({
        title: "Live Resume - Iash Kumar Tripathy",
        text: "Hello, I am student pursuing my masters in Computer Science from INTERNATIONAL INSTITUTE OF INFORMATION TECHNOLOGY, BANGALORE. Find out more in my live-resume!",
